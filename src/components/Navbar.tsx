        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="space-x-6 hidden md:flex font-bold">
              ...
              <div className="text-white hover:text-amber-500 hover:cursor-pointer transition" onClick={() => setModalOpen(true)}>Contact</div>
            </div>
          </div>
        </div>
      </nav>
      <Contact isOpen={modalOpen} onClose={() => setModalOpen(false)}/>
    </>
  );
}
